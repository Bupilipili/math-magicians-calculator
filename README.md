...
# 📖 math-magicians-calculator <a name="about-project"></a>

**math-magicians-calculator** is an application that allows users to access a web calculator which comes with random quotes. 
...
Example commands:
  ...
  git clone https://github.com/Bupilipili/math-magicians-calculator.git
...
Feel free to check the [https://github.com/Bupilipili/math-magicians-calculator/issues].
